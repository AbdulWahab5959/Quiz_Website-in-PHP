		   	...
		   	<li style="background-image: url(images/img_bg_2.jpg);">
		   		...
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1>Test your knowledge, challenge your code: Programming quizzes for all levels.</h1>
									<h2>Brought to you by <a href="#" target="_blank">Pak_Quiz.com</a></h2>
									<p><a class="btn btn-primary btn-lg btn-learn" href="#">Start Quiz Now!</a></p>
			   				</div>
			   			</div>
			   		</div>
		   		</div>
		   	...
		   	<li style="background-image: url(images/img_bg_3.jpg);">
		   		...
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1>From syntax to solutions: Ace your coding with interactive quizzes.</h1>
									<h2>Brought to you by <a href="#" target="_blank">Pak_Quiz.com</a></h2>
									<p><a class="btn btn-primary btn-lg btn-learn" href="#">Start Quiz Now!</a></p>
			   				</div>
			   			</div>
